...
project = sys.argv[1]
bsk_files = glob.glob(f"./{project}/*.bsk")
...
audio_files = glob.glob(f"./{project}/*.mp3")
...
Path(GLOBAL_MANIFEST).write_text(json.dumps(manifest, indent=4, sort_keys=True))
